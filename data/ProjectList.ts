...
export const ProjectList: ProjectType[] = [
  {
    realSrc: "https://parking.kakao.com/",
    githubSrc: "",
    title: "이마트 출입정보 연동 개발",
    desc: "이마트에 들어갈 주차연동 서버 개발, 입/출차 정보를 실시간으로 전송 및 이마트 POS정보에서 전달하는 정보를 이용하여 주차할인권 등록 및 관리 프로세서 개발",
    company: "알에스솔루션즈",
    fromAt: "2023. 08",
    toAt: "2023. 09",
    language: [
  ...
  },
  {
    realSrc: "https://parking.kakao.com/",
    githubSrc: "",
    title: "경북대학교 학생, 정기권 정보 연동 개발",
    desc: "경북대학교에서 관리하는 정기권 정보를 실시간으로 전송 받을 수 있는 API 프로세서 개발, 추가로 QR리더기를 이용하여 재학생 정보를 API로 연동하여 학생 여부를 판단하여 주차할인권 등록 프로세서 개발, 또한 주차요금 사전 웹결제를 토스페이먼츠를 이용하여 추가 연동 개발",
    company: "알에스솔루션즈",
    fromAt: "2023. 08",
    toAt: "2023. 09",
    language: [
  ...
  },
  {
    ...
    githubSrc: "",
    title: "카카오T 특정 할인 연동",
    desc: "카카오T에서 전달하는 특정 할인 코드를 이용하여 주차요금을 변경시키는 프로세서 개발, 해당 프로세서에는 주/야간 정기권 연동도 포함되어 추후 연장 개발 가능성을 열어두고 개발",
    company: "알에스솔루션즈",
    fromAt: "2023. 07",
    toAt: "2023. 08",
    language: [
  ...
  },
  {
    realSrc: "https://parking.kakao.com/",
    githubSrc: "",
    title: "에스원 출동 연동 시스템 개발",
    desc: "에스원 <-> 주차서버간 출동 연동시스템을 연동 개발하여 에스원이 담당하는 주차장일 경우 에스원 콜센터에서 주차서버를 이용하여 현장 출동을 요청하는 연계 프로세서 개발",
    company: "알에스솔루션즈",
    fromAt: "2023. 06",
    toAt: "2023. 07",
    language: [
  ...
  },
  {
    realSrc: "https://parking.kakao.com/",
    githubSrc: "",
    title: "주차요금 PG 사전결제 개발",
    desc: "스마트로 PG 연동 결제를 이용하여 입차된 차량 고객이 특정 QR코드를 이용하여 차량 조회 후 주차요금을 선결제 후 빠른 출차 프로세서 개발(PG사 : 스마트로)",
    company: "알에스솔루션즈",
    fromAt: "2023. 04",
    toAt: "2023. 05",
    language: [
  ...
  },
  {
    realSrc: "https://parking.kakao.com/",
    githubSrc: "",
    title: "현대자동차 울산공장 출입통제 연동 개발",
    desc: "포스트엠비 주차장비와 연동 후 현대오토에버 출입연동API 정보를 이용하여 차량 입출차 통제 프로그램 개발, 기존 요금 결제 방식 프로세서에서 입출차 통제로 변형 개발, 차량 입차시 특정 페이지에 웹소켓으로 이용하여 출입정보가 실시간으로 표시되는 기능 추가",
    company: "알에스솔루션즈",
    fromAt: "2023. 01",
    toAt: "2023. 03",
    language: [
